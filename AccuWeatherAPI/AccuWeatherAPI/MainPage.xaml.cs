    ...
    public sealed partial class MainPage : Page
    {
        ...
        private async void InitJSON()
        {
            ...
            list.ForEach(it =>
            {
                ...
                it.WeatherIcon = string.Format("http://vortex.accuweather.com/adc2010/images/slate/icon/{0}.svg",
                    it.WeatherIcon);
        ...
        private async void InitEachDaysJSON()
        {
            ...
            obj.DailyForecasts.ForEach(it =>
            {
                ...
                it.Day.Icon = string.Format("http://vortex.accuweather.com/adc2010/images/slate/icon/{0}.svg", it.Day.Icon);
                //string.Format("http://vortex.accuweather.com/adc2010/images/slate/icon/{0}.svg", it.Day.Icon);
            ...
            MaxTemperature.Text = WeatherEachDays[0].Temperature.Minimum.Value + "";
